...
export class YearRecapComponent {
  ...
  stats = computed(() => {
    ...
    const totalEpisodes = yearAnime.reduce((acc, a) => acc + (a.progressCurrent || 0), 0);
    ...
    const droppedFastest = droppedAnime.sort((a, b) => (a.progressCurrent || 0) - (b.progressCurrent || 0))[0];
